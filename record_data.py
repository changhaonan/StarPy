...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_name", type=str, default="exp_3")
    ...
    with open(os.path.join(args.data_folder, args.data_name, "intrinsics.txt"), "w") as f:
        f.writelines(
            [
                f"fx: {color_intrinsics.fx}\n",
                f"fy: {color_intrinsics.fy}\n",
                f"cx: {color_intrinsics.ppx}\n",
                f"cy: {color_intrinsics.ppy}\n",
            ]
        )
